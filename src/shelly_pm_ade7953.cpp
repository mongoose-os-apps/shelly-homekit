...
StatusOr<std::vector<PowerMeter *>> PowerMeterInit() {
  ...
  res.push_back(new ADE7953PowerMeter(1, s_ade7953, 1));
  res.push_back(new ADE7953PowerMeter(2, s_ade7953, 0));
